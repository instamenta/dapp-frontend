    ...
    return (
        <>
            ...
            <aside id="separator-sidebar" aria-label="Sidebar"
                   className="fixed left-0 z-10 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 gap-4">
                    {//@ts-ignore
                        [...Array(12).keys()].map((index) => (
                        <div key={index} className="flex items-center justify-center rounded bg-gray-50 h-28 dark:bg-gray-800">
