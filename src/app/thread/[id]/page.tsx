...
import BlogPost from "@/components/shared/markdown/BlogPost";

const ThreadDetails = async () => {
	const sample = data[0];
	return (<>
			<article
				className="w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert p-6 border-2 m-6 border-dashed border-gray-600 rounded-2xl">
				<header className="mb-4 lg:mb-6 not-format p-6 border-2 border-dashed border-gray-600 rounded-2xl">
					<address className="flex items-center mb-6 not-italic">
						<div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
							<img className="mr-4 w-16 h-16 rounded-full"
							     src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Jese Leos"/>
							<div>
								<a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">Jam Jam</a>
					...
					<h1
						className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">{sample.name}</h1>
				</header>
				<section className="border-2 border-dashed p-6 border-gray-600 rounded-2xl">
					<div className="order-dashed border-gray-600 rounded-2xl overflow-hidden">
						<img src=" https://kinsta.com/wp-content/uploads/2019/08/jpg-vs-jpeg.jpg" alt="Thread Image"
						     className="content-center object-cover w-full overflow-hidden rounded-2xl"/>
					</div>

					<article className="py-8">

						<BlogPost content={sample.content} />
					...
					<article className="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
						...
						<div className="flex items-center mt-4 space-x-4">
							<button type="button"
								...
								<svg className="mr-1.5 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
