    ...
    return (
        <>
            <nav className="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <div className="relative hidden md:block">
                            ...
                            <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                        ...
                        <div className="relative mt-3 md:hidden">
                            ...
                            <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500
                    ...
                    dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <Link href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white
                ...
                <ul className="flex bg-blue-950">
                    <li className="overflow-hidden pt-2 border-b-2 border-b-purple-600 text-sm px-3 pb-2">Threads</li>
                    <li className="overflow-hidden pt-2 border-b-2 text-sm px-3 pb-2 ">Product</li>
                    <li className="overflow-hidden pt-2 border-b-2 text-sm px-3 pb-2 ">Mogurt</li>
                    <li className="overflow-hidden pt-2 border-b-2 text-sm px-3 pb-2 ">Popular</li>
                    <li className="overflow-hidden pt-2 border-b-2 text-sm px-3 pb-2 ">Pepegata</li>
                    <li className="overflow-hidden pt-2 border-b-2 text-sm px-3 pb-2 ">Information</li>
                </ul>
            </nav>
